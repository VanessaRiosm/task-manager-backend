 ...
 */
router.get('/', tasks_service_1.getTasks);
/**
 * @swagger
 * /api/tasks:
 *   post:
 ...
 */
router.post('/', tasks_service_1.addTask);
/**
 * @swagger
 * /api/tasks/{id}:
 *   get:
 ...
 */
router.get('/:id', tasks_service_1.getTaskById);
/**
 * @swagger
 * components:
 *   schemas:
 ...
 */
router.put('/:id', tasks_service_1.updateTask);
/**
 * @swagger
 * /api/tasks/{id}:
 *   delete:
 ...
 */
router.delete('/:id', tasks_service_1.deleteTask);
